...
def parseArguments():
	...
	parser.add_argument("--host", help="Host name to be used by the server. Don\'t specify this argument to use default value (localhost)")
	parser.add_argument("--port", help="Host port to be used by the server. Don\'t specify this argument to use default value (8000)")
